...
public class SocketServer {
    ...
    static class ServerSocketChannelHandle implements CompletionHandler<AsynchronousSocketChannel, Void>{
         ...
         * 日志
         */
        private final Log LOGGER = LogFactory.getLog(ServerSocketChannelHandle.class);
        ...
        public void completed(AsynchronousSocketChannel socketChannel, Void attachment) {
            ...
            socketChannel.read(readBuffer,new StringBuffer()
                    ,new SocketChannelReadHandle(socketChannel , readBuffer));
        }
    ...
    static class SocketChannelReadHandle implements CompletionHandler<Integer, StringBuffer>{
         ...
         * 日志
         */
        private final Log LOGGER = LogFactory.getLog(SocketChannelReadHandle.class);
